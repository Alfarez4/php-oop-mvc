...
/**
 * Kelas inti untuk koneksi database menggunakan PBO
...
class database
{
    ...
    public function __construct()
    {
        ...
        $option = [
            ...
            PDO::ATTR_ERRMODE => PDO::ERRMODE_EXEPTION // Mengaktifkan error mode exception
        ];

        try {
            $this->dbh = new PDO($dsn, $this->user, $this->pass, $option);
        } catch (PDOException $e) {
            // Tanggal error koneksi dan hentikan aplikasi
    ...
    /**
     * Binding nilai ke parameter placeholder di querry
